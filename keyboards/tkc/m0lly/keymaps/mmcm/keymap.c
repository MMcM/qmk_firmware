...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------| |--------------|    |
     * |Ctrl|Gui |Alt |      Space           | Alt | Gui |FN  |Ctr | |   0     | .  |    |
     * `-----------------------------------------------------------' '-------------------'
     */
    [_BASE] = LAYOUT_all(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,    KC_BSPC, XXXXXXX,     KC_NUM, KC_PSLS, KC_PAST, KC_PEQL,
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, KC_RGUI, MO(_FUNC), KC_RCTL,              KC_P0,   XXXXXXX, KC_PDOT, KC_PENT
    ),
     ...
     */
    [_FUNC] = LAYOUT_all(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, _______, QK_BOOT,   XXXXXXX,     _______, _______, _______, _______,
        ...
        _______, XXXXXXX, RM_TOGG, RM_NEXT, RM_HUED, RM_HUED, RM_SATU, RM_SATD, RM_VALU, RM_VALD, BL_STEP, _______, _______, XXXXXXX,              _______, _______, _______, XXXXXXX,

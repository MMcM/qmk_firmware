...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(
    KC_TAB,    KC_ESC,    KC_DOWN, KC_UP, KC_LEFT, KC_RIGHT, KC_HOME, KC_END, KC_DELETE, KC_INSERT, KC_BACKSPACE,
    ...
    KC_LEFT_SHIFT, KC_Z,      KC_X,    KC_C,  KC_V,    KC_B,     KC_N,    KC_M,   KC_COMM,   KC_DOT,    KC_QUESTION,
    KC_LEFT_CTRL,  KC_SPACE,  KC_RALT
  )

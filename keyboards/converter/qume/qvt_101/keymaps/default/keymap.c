...
/*
 *     +---+                                   +---+---+---+---+---+---+   +---+---+---+---+
 *     |Set|                                   |Prt|Up |Dwn|Lft|Rgt|Clr|   |PF1|PF2|PF3|PF4|
 *     +---------------------------------------------------------------+   +---------------+
 ...
 */
    ...
    [0] = LAYOUT(
  KC_PAUS, KC_PSCR, KC_UP, KC_DOWN, KC_LEFT, KC_RIGHT, KC_HOME, KC_F1, KC_F2, KC_F3, KC_F4, \
  ...
  KC_LCTL, KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, KC_BSLS, KC_P1, KC_P2, KC_P3, KC_PENT, \
  KC_SCRL, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, /*KC_RSFT,*/ QK_DEBUG_TOGGLE, KC_P0, KC_PDOT, \
  KC_SPC \
    )
} ;

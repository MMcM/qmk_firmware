 ...
 */
  ...
  [BASE] = LAYOUT(
    ...
    KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, JP_YEN, KC_INS,
    KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_GRV, KC_LBRC, KC_RBRC,
    KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_NUBS, KC_ENT,
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, /*KC_RSFT,*/ KC_UP, JP_KANA,
  ...
  [GRAPH] = LAYOUT(
    ...
    KC_NO, A(KC_1), A(KC_2), A(KC_3), A(KC_4), A(KC_5), A(KC_6), A(KC_7), A(KC_8), A(KC_9), A(KC_0), A(KC_MINS), KC_NO, A(JP_YEN), KC_NO,
    ...
    KC_NO, KC_NO, A(KC_X), A(KC_C), A(KC_V), A(KC_B), A(KC_N), A(KC_M), A(KC_COMM), A(KC_DOT), A(KC_SLSH), KC_NO, KC_NO,

 ...
 *
 * This keymap assumed separate keycaps for: `~ to the left of 1, ] after [ and before RETURN, \ after ' and before RETURN.
 */
  [0] = LAYOUT(
    KC_ESC, KC_F1, KC_F2, KC_F3,         KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINUS, KC_EQUAL, KC_BSPACE,           KC_NLCK, KC_F4, KC_F5, KC_F6,
    KC_UP, KC_INS, KC_HOME, KC_PGUP,     KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRACKET, KC_RBRACKET, KC_ENTER,      KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_ENTER,
           KC_DEL, KC_END, KC_PGDN,      KC_CAPSLOCK, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCOLON, KC_QUOTE, KC_BSLASH,           KC_KP_4, KC_KP_5, KC_KP_6,

 ...
 */
  ...
  [0] = LAYOUT(
    ...
    KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, JP_YEN, RBRC_OR_PDOT,    KC_LNG5, KC_DEL,  KC_INS, \
    KC_INT2, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, JP_BSLS, KC_GRV, KC_LBRC, KC_ENT,                                    KC_PAST, KC_PSLS, KC_PPLS, KC_PMNS, \
    ...
    KC_LCTL, KC_LALT, KC_TAB, KC_LNG1, KC_LNG2, KC_SPACE, JP_KANA, KC_LNG4, KC_CAPS, JP_KANA,                                                KC_P1,   KC_P2,   KC_P3,   KC_PENT, \
                   JP_MHEN, JP_HENK,                                                                          KC_RGUI,                     KC_P0,            KC_PCMM
  )
} ;

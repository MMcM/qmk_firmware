 ...
 */
  ...
  [0] = LAYOUT(
    ...
    KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINUS, KC_EQUAL, KC_BSPACE, KC_PSCR, KC_INSERT, KC_DELETE, KC_F21, KC_F22, KC_F23, KC_F24, \
    KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRACKET, KC_RBRACKET, KC_ENTER, KC_HOME, KC_PGUP, KC_PGDOWN, KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_MINUS, \
    ...
    KC_LSHIFT, KC_GRV, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_RSHIFT, KC_LEFT, KC_DOWN, KC_RIGHT, KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_ENTER, \

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [DEFAULT] = LAYOUT(
        ...
        KC_LSFT, KC_Z,      KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, MO(FN1),
        KC_LCTL, KC_LALT,                   KC_SPC,  KC_BSPC,                            MO(FN2), KC_RGUI
    ),

    [FN1] = LAYOUT(
        KC_TRNS,                                                                                  KC_TRNS,
                 KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
        KC_MINS, KC_EQL,  KC_GRV,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_QUOT, KC_SCLN, KC_TRNS,
        KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_SLSH, KC_BSLS, KC_DOT,  KC_TRNS,

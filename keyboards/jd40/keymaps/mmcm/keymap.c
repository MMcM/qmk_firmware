...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO(_FUNC), KC_SPC,  KC_SPC,  MO(_FUNC), KC_RALT, KC_RGUI, KC_RCTL
    ),
    ...
    [_FUNC] = LAYOUT(
        ...
        _______, BL_TOGG, BL_STEP, _______, _______, _______, _______, _______, KC_SCLN, KC_QUOT, KC_UP,
